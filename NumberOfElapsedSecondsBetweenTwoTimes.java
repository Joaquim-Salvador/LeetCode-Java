...
public class NumberOfElapsedSecondsBetweenTwoTimes {
    public int secondsBetweenTimes(String startTime, String endTime) { 
        String[] horarioInicial = startTime.split("\\:");
        String[] horarioFinal = endTime.split("\\:");

        int primeira = (Integer.parseInt(horarioInicial[0])*3600) + (Integer.parseInt(horarioInicial[1])*60) + (Integer.parseInt(horarioInicial[2])); 
        int segunda = (Integer.parseInt(horarioFinal[0])*3600) + (Integer.parseInt(horarioFinal[1])*60) + (Integer.parseInt(horarioFinal[2]));

        int resultado = Math.abs(primeira - segunda);
    ...
    public static void main(String[] args) {
        NumberOfElapsedSecondsBetweenTwoTimes teste = new NumberOfElapsedSecondsBetweenTwoTimes();

        System.out.println(teste.secondsBetweenTimes("12:34:56","13:00:00"));
    }
}
